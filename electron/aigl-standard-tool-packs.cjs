    ...
    Object.freeze({
        ...
        tools: Object.freeze([
            Object.freeze({
                ...
                examples: Object.freeze([Object.freeze({ path: 'F:/AIGril/input/report.pdf', output_format: 'json', ocr: 'auto' })]),
            ...
            Object.freeze({
                ...
                examples: Object.freeze([Object.freeze({ path: 'F:/AIGril/input/brief.docx', max_chars: 30000, include_metadata: 'true' })]),
            ...
            Object.freeze({
                ...
                examples: Object.freeze([Object.freeze({ path: 'F:/AIGril/input/secret-santa.docx', max_chars: 50000, output_format: 'markdown' })]),
...
function searchStandardToolPacks(query = '', { limit = 12, includeTools = true } = {}) {
    ...
    return listStandardToolPacks({ includeTools })
        .map((pack) => ({
            ...
            source: 'aigl_standard_tool_pack_catalog',
